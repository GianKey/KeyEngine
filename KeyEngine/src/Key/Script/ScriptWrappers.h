...
namespace Key { namespace Script {
	...
	// Physics
	MonoArray* Key_Physics_OverlapBox(glm::vec3* origin, glm::vec3* halfSize);
	MonoArray* Key_Physics_OverlapCapsule(glm::vec3* origin, float radius, float halfHeight);
	MonoArray* Key_Physics_OverlapSphere(glm::vec3* origin, float radius);
	int32_t Key_Physics_OverlapBoxNonAlloc(glm::vec3* origin, glm::vec3* halfSize, MonoArray* outColliders);
	int32_t Key_Physics_OverlapCapsuleNonAlloc(glm::vec3* origin, float radius, float halfHeight, MonoArray* outColliders);
	int32_t Key_Physics_OverlapSphereNonAlloc(glm::vec3* origin, float radius, MonoArray* outColliders);
	...
	MonoString* Key_TagComponent_GetTag(uint64_t entityID);
	void Key_TagComponent_SetTag(uint64_t entityID, MonoString* tag);
	...
	void Key_TransformComponent_GetWorldSpaceTransform(uint64_t entityID, TransformComponent* outTransform);
