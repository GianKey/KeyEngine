...
namespace Key {
	...
	public:
		...
		virtual Ref<Image2D> GetImage(uint32_t attachmentIndex = 0) const override { KEY_CORE_ASSERT(attachmentIndex < m_AttachmentImages.size()); return m_AttachmentImages[attachmentIndex]; }
