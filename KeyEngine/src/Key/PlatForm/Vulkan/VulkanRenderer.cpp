...
namespace Key {
		...
		Renderer::Submit([]()
			{
				...
				KEY_CORE_ASSERT(s_Data->ActiveCommandBuffer);
	...
	{
		//KEY_CORE_ASSERT(s_Data->m_ActiveRenderPass, "No active render pass! Have you called Renderer::EndRenderPass twice?");
