		...
		Renderer::Submit([this, srgb]()
			{
				...
				else
				{
					...
					glTexImage2D(GL_TEXTURE_2D, 0, KeyToOpenGLTextureFormat(m_Format), m_Width, m_Height, 0, srgb ? GL_SRGB8 : KeyToOpenGLTextureFormat(m_Format), GL_UNSIGNED_BYTE, m_ImageData.Data);
					glGenerateMipmap(GL_TEXTURE_2D);
